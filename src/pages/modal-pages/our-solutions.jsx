...
import "../../Styles/layout/OurSolutions.module.scss";
...
const OurSolutions = () => {
  ...
  const handleActionClick = () => {
    closeItemDetail();
    router.push("/hire-talent/step2"); // Use router.push for navigation in Next.js
  };
    ...
    <section className="our-solutions">
      <div className="container">
        ...
        <p className="section-intro">
          Discover the wide range of solutions we offer to empower your
          business.
        </p>
