...
import '../../Styles/ModalPages/HireAssistants.module.scss';
import categories from '../../../public/data/skills/assistantsData';
...
const HireAssistants = () => {
  ...
  const handleActionClick = () => {
    ...
    router.push('/hire-talent/step2');  // Navigate to the hire assistant process in Next.js
  };
